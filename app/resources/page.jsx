  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col items-center justify-center pt-[30px]">
        <div className="flex flex-col justify-between rounded-[15px] border-2 border-accent bg-gradient-to-b from-[#739DED66] via-[#A8AEE000] to-[#fad1031a] p-6 transition-all duration-500 md:p-10">
          <MultiSteps />
        </div>
      </div>
