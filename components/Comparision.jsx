  ...
  return (
    <section className="mt-7 flex flex-col">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="mt-10 w-[84vw] text-clamptextsmm font-medium leading-9 xxl:text-[1.5vw] xxl:leading-normal">
        ...
        <div className="mt-[40px] w-[84vw] text-clamptextsmm font-medium leading-9 xxl:text-[1.5vw] xxl:leading-normal">
        ...
        <div className="mb-[3rem] mt-[40px] w-[84vw] text-clamptextsmm font-medium leading-9 xxl:text-[1.5vw] xxl:leading-normal">
