      ...
      <div className="my-7 flex flex-col items-center justify-center px-[30px] sm:px-[50px] xl:px-[15vw]">
        <div className="flex flex-col items-center justify-center [&>div]:text-justify">
          ...
          <div className="mt-10 text-clamptextsmm font-medium leading-9 xxl:text-[1.5vw] xxl:leading-normal">
            ...
            to take security decisions based on cognitive thinking as a leader.
            To Establish yourself as a Subject Matter Expert (SME) and a thought
          ...
          <div className="mt-[40px] text-clamptextsmm font-medium leading-9 xxl:text-[1.5vw] xxl:leading-normal">
            ...
            and has been programmed for busy working professionals to
