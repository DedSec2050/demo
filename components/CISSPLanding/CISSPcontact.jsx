...
const LeadGen = () => {
  ...
  return (
    <div className="z-[-1] ml-2 mr-[3vw] flex w-full translate-y-8 flex-col items-center justify-center pb-8 md:ml-0 md:gap-x-6">
      <h2 className="py-4 text-[1.3rem] font-bold text-companyBlue xl:text-[1.9rem]">
      ...
      >
        ...
        {flag ? (
          <span className="pb-4 font-bold text-[purple] md:text-[1.2rem]">
