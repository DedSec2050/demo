    ...
    <section className="hidden md:flex [&>div]:h-[80dvh]">
      ...
      >
        <SwiperSlide className="">
          <div className="bg-slidebgOne flex h-[80dvh] w-[100dvw] flex-col justify-center bg-cover [&>div]:px-10 [&>div]:py-10">
        ...
        <SwiperSlide className="">
          <div className="bg-slidebgTwo flex h-[80dvh] w-[100dvw] flex-col justify-center bg-cover [&>div]:px-10 [&>div]:py-10">
            <div className="top-0 px-10 py-10 font-bold leading-normal [&>.accent]:text-accent [&>h2]:text-[2.6rem] xl:[&>h2]:text-[3.4rem]">
              <h2>
                Our Courses <br />
              </h2>
        ...
        <SwiperSlide className="">
          <div className="bg-slidebgFour flex h-[80dvh] w-[100dvw] flex-col justify-center bg-cover [&>div]:px-10 [&>div]:py-10">
            <div className="top-0 px-10 py-10 font-bold leading-normal [&>.accent]:text-accent [&>h2]:text-[2.6rem] xl:[&>h2]:text-[3.4rem]">
              <h2>
                Corporate Trainings
                <br />
        ...
        <SwiperSlide className="">
          <div className="bg-slidebgThree flex h-[80dvh] w-[100dvw] flex-col justify-center bg-cover [&>div]:px-10 [&>div]:py-10">
