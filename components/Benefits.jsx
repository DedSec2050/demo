...
const Benefits = () => {
  return (
    <section>
      <div className="px-[30px] sm:px-[50px] md:mb-[150px] xl:px-[10vw]">
        <div className="flex flex-col items-center justify-center xxl:mt-[40px]">
          <h2 className="mb-[5vh] mt-[5vh] bg-gradient-to-r from-grn to-accent bg-clip-text text-clamptitle font-bold text-transparent xl:px-[7vw] xxl:mb-[20px] xxl:text-[2.5vw]">
