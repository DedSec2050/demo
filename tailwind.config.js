  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        sldbgOne: "url(/assets/pf/f11.webp)",
        sldbgTwo: "url(/assets/pf/f12.webp)",
        sldbgThree: "url(/assets/pf/f13.webp)",
        sldbgFour: "url(/assets/pf/f14.webp)",
        mobilebg: "url(/assets/LandingSwiper/SwiperSlide1.webp)",
        slidebgOne: "url(/assets/LandingSwiper/SwiperSlide1.webp)",
        slidebgTwo: "url(/assets/LandingSwiper/SwiperSlide2.webp)",
        slidebgThree: "url(/assets/LandingSwiper/SwiperSlide3.webp)",
